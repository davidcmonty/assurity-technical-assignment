...
describe('Assurity Technical Assignment', () => {
  ...
  it('1: Element "Name" is equal to "Carbon Credits"', function () {
    cy.request(api)
  ...
  it('3: Promotions element with Name "Gallery", has a Description that contains the text "2x larger image"', function () {
